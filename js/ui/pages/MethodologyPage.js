...
export default function MethodologyPage() {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      'Как работают алгоритмы приложения и почему они выглядят именно так.'
    ),
    ...
    // ── 1. Recovery Score ──
    React.createElement(SectionCard, { icon: '\uD83D\uDCCA', title: 'Recovery Score', id: 'recovery-score' },
      ...
      React.createElement('div', { className: 'text-sm', style: { color: 'var(--text2)' } },
        ...
        React.createElement('ul', { style: { margin: '0.25rem 0', paddingLeft: '1.2rem' } },
          ...
          React.createElement('li', null, 'ЧСС покоя: инвертированный z-score. Рост на 5+ уд/мин \u2014 тревожный сигнал.'),
          React.createElement('li', null, 'Субъективные: среднее энергии, настроения и инвертированной болезненности (\u00D72).')
        )
      ),
      React.createElement(WhyText, null,
        'Композитный индекс восстановления надежнее любого отдельного маркера. HRV и сон объясняют ~70% дисперсии, поэтому они получают наибольший вес.'
      )
    ),

    // ── 2. APRE ──
    React.createElement(SectionCard, { icon: '\uD83C\uDFAF', title: 'APRE (Auto-regulation by Performance)', id: 'apre' },
    ...
    // ── 3. Session Load ──
    React.createElement(SectionCard, { icon: '\u2696\uFE0F', title: 'Session Load (Фостер, 2001)', id: 'session-load' },
    ...
    // ── 5. HRV-бейзлайн ──
    React.createElement(SectionCard, { icon: '\uD83D\uDCC8', title: 'HRV-бейзлайн (14 дней)', id: 'hrv-baseline' },
